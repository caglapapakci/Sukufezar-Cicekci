...
namespace Projem.WebUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        Repository<TContent> repoContent = new Repository<TContent>();
        ...
        public ActionResult Index()
        {
            ...
            IndexVM IndexVM = new IndexVM
            {
                ...
                NewestProducts = repoProduct.GetAll().Include(i => i.Pictures).Include(i => i.Favorites).OrderByDescending(o => o.ID).Take(8).ToList(),
        ...
        {
            return PartialView(repoContent.GetAll());
        }
        public ActionResult Head()
        {

            //Üye bilgilerini görüntülemek için
           if(User.Identity.IsAuthenticated) TempData["Member"] = repoMember.GetBy(w => w.MailAddress == User.Identity.Name).ID;
